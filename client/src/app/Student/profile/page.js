  ...
  return (
    <div className="py-10 ">
      <div className="w-[900px] m-auto border-[1px] border-inherit bg-slate-200 rounded-lg">
        ...
        <p className="text-[8px] text-center mb-1">Click on Profile for Uploade  </p>
      ...
      <div className="pt-3">
        ...
        {student.internships.length === 0 ? <h3 className="text-xl text-gray-500 m-auto py-2 text-center"> You have not applyed for any job yet!</h3>
      ...
      <div className="pt-5 ">
        ...
        {student.internships.length === 0 ? <h3 className="text-xl text-gray-500 text-center py-3"> You have not applyed for any Internship yet</h3>
        : <div className="flex  px-4 ">
        {student && 
